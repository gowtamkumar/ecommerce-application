...
export default async function Support() {
  ...
  const sections = (helpSupport?.sections || [
    { slug: "hero", status: true, sequence: 1 },
    { slug: "support_options", status: true, sequence: 2 },
  ...
  let apiFaqs = [];
  if (setting?.faq && Array.isArray(setting.faq)) {
    apiFaqs = setting.faq;
  }
  ...
  const sectionMap: Record<string, React.ReactNode> = {
    hero: (
      <section key="hero" className="relative h-[40vh] min-h-[400px] flex items-center justify-center overflow-hidden">
    ...
    support_options: (
      <section key="support_options" className="relative z-20 -mt-24 pb-10 px-4">
    ...
    faqs: (
      <section key="faqs" className="py-20 px-4">
    ...
    contact_form: (
      <section key="contact_form" className="py-20 bg-gray-100/50 px-4">
