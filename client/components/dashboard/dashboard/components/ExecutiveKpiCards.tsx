...
export default function ExecutiveKpiCards({
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          ...
          <div className="mt-3">
            ...
            <div className="mt-2 flex items-center justify-between text-xs">
              <span className="text-global-primary font-bold flex items-center gap-1">
                <FiArrowUpRight className="text-sm" /> Delivered & Paid
              </span>
      ...
      <div className="bg-white rounded-2xl p-5 border border-gray-100 hover:border-global-primary/30 shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden group">
          ...
          <div className="mt-3">
            ...
            <div className="mt-2 flex items-center justify-between text-xs">
              ...
              {Number(total_pending_order_count) > 0 ? (
                <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[11px] font-bold bg-global-primary/15 text-global-primary border border-global-primary/25 animate-pulse">
