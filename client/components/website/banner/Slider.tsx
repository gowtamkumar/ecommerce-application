                    ...
                    <div className="pt-4">
                      <Link href={url || "/products"}>
                        <Button
                          type="primary"
                          size="large"
                          className="!h-14 !px-10 !text-lg !font-medium !bg-white !text-black !border-none hover:!bg-primary hover:!text-white transition-all duration-300 flex items-center gap-2 group/btn shadow-xl hover:shadow-2xl hover:-translate-y-1"
                        >
                          Shop Now
