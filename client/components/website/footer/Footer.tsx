...
export default function WebFooter() {
  return (
    <footer className="bg-[#111] text-gray-300 font-sans">
      {/* Top Features */}
      ...
      <div className="bg-[#1a1a1a] py-8 border-t border-gray-800">
      ...
      <div className="bg-black py-6 border-t border-gray-900">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-500">
          ...
          <div className="flex gap-3">
             ...
             <div className="w-10 h-6 bg-gray-800 rounded flex items-center justify-center text-[8px] text-gray-400">VISA</div>
             <div className="w-10 h-6 bg-gray-800 rounded flex items-center justify-center text-[8px] text-gray-400">MC</div>
             <div className="w-10 h-6 bg-gray-800 rounded flex items-center justify-center text-[8px] text-gray-400">PAYPAL</div>
          </div>
        </div>
      </div>
    </footer>
