  ...
  return (
    ...
    >
      <Image
        ...
        className="h-auto w-auto max-h-[50px] object-contain transition-all duration-300 group-hover:scale-105 group-hover:drop-shadow-[0_0_8px_var(--global-primary)]"
      />
