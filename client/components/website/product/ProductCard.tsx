...
// <div
// className={`grid gap-5 ${global.productView ? "grid-cols-1" : "lg:grid-cols-4"
//   }`}
// >
...
//     <div
//       key={item.id}
//       className={`grid ${global.productView ? "gap-5 grid-cols-2" : "text-center"
//         } p-2  h-full`}
//     >
...
//               </div>
//             </div>
//             <p className="text-bioxin-p text-gray-500">
//               {item.description}
//             </p>
//             <button
//               className="btn-primary-bioxin self-end"
