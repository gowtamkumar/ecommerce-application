  ...
  return (
    ...
    >
      {(products || []).map((item: any) => {
        let price = +item.productVariants[0].price || 0;
        let reviewsCount = +item.reviews.length || 0;
        ...
        // calculation ProductRating
        const productRating = item.reviews.reduce(function (
          accumulator: any,
          currentValue: any
        ) {
        ...
        0);
        // calculation StockQty
        const stockQty = item.productVariants.reduce(function (
          accumulator: any,
          currentValue: any
        ) {
          return accumulator + +currentValue.stockQty;
        },
        0);
