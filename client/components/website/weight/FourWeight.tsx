  ...
  return (
    <div className="space-y-6">
      <div className="space-y-3">
        ...
        <p className="text-sm text-global-footer-text/60 leading-relaxed">
          Subscribe to our newsletter and never miss exclusive offers, updates, and more.
        </p>
      </div>
      ...
      {/* Trust indicator */}
      <p className="text-xs text-global-footer-text/40 flex items-center gap-2">
