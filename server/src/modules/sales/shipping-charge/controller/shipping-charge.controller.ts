...
// @access Public
export const getShippingCharges = asyncHandler(async (req: Request, res: Response) => {
...
// @access Public
export const createShippingCharge = asyncHandler(async (req: CustomRequest, res: Response) => {
...
// @access Public
export const updateShippingCharge = asyncHandler(async (req: Request, res: Response) => {
...
// @access Public
export const deleteShippingCharge = asyncHandler(async (req: Request, res: Response) => {
