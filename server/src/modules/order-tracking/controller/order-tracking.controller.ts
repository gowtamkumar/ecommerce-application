...
// @access Public
export const getOrderTrackings = asyncHandler(async (req: Request, res: Response) => {
...
// @access Public
export const createOrderTracking = asyncHandler(async (req: CustomRequest, res: Response) => {
...
// @access Public
export const deleteOrderTracking = asyncHandler(async (req: Request, res: Response) => {
